...
class ShoppingPreferencesUpdateScreen extends ConsumerStatefulWidget {
  const ShoppingPreferencesUpdateScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<ShoppingPreferencesUpdateScreen> createState() => _ShoppingPreferencesUpdateScreenState();
}

class _ShoppingPreferencesUpdateScreenState extends ConsumerState<ShoppingPreferencesUpdateScreen> {
