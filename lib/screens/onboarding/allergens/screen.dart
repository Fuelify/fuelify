...
class AllergensUpdateScreen extends ConsumerStatefulWidget {
  const AllergensUpdateScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<AllergensUpdateScreen> createState() => _AllergensUpdateScreenState();
}

class _AllergensUpdateScreenState extends ConsumerState<AllergensUpdateScreen> {
