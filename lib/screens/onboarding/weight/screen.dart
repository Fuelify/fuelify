...
class WeightGoalsUpdateScreen extends ConsumerStatefulWidget {
  const WeightGoalsUpdateScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<WeightGoalsUpdateScreen> createState() => _WeightGoalsUpdateScreenState();
}

class _WeightGoalsUpdateScreenState extends ConsumerState<WeightGoalsUpdateScreen> {
