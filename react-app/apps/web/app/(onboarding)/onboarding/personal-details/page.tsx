...
// Mirrors: lib/screens/onboarding/personal/screen.dart
export default function OnboardingPersonalDetailsPage() {
  ...
  return (
    <div>
      ...
      <p>Onboarding step 2 — TODO: port UI from Flutter personal/screen.dart</p>
