...
// Mirrors: lib/screens/onboarding/habits/screen.dart
export default function OnboardingEatingHabitsPage() {
  ...
  return (
    <div>
      <h2>Eating Habits</h2>
      <p>Onboarding step 5 — TODO: port UI from Flutter habits/screen.dart</p>
