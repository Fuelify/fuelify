...
// Mirrors: lib/screens/onboarding/diet/screen.dart
export default function OnboardingDietPreferencesPage() {
  ...
  return (
    <div>
      ...
      <p>Onboarding step 3 — TODO: port UI from Flutter diet/screen.dart</p>
