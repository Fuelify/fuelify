...
// Mirrors: lib/screens/onboarding/allergens/screen.dart
export default function OnboardingAllergensPage() {
  ...
  return (
    <div>
      <h2>Allergens</h2>
      <p>Onboarding step 4 — TODO: port UI from Flutter allergens/screen.dart</p>
