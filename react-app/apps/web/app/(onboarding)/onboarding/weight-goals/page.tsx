...
// Mirrors: lib/screens/onboarding/weight/screen.dart
export default function OnboardingWeightGoalsPage() {
  ...
  return (
    <div>
      <h2>Weight Goals</h2>
      <p>Onboarding step 8 — TODO: port UI from Flutter weight/screen.dart</p>
