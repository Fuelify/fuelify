...
// Mirrors: lib/screens/onboarding/primary/screen.dart
export default function OnboardingPrimaryGoalPage() {
  ...
  return (
    <div>
      <h2>Primary Goal</h2>
      <p>Onboarding step 7 — TODO: port UI from Flutter primary/screen.dart</p>
