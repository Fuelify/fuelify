...
// Mirrors: lib/screens/onboarding/devices/screen.dart
export default function OnboardingDeviceConnectionsPage() {
  ...
  return (
    <div>
      ...
      <p>Onboarding step 11 — TODO: port UI from Flutter devices/screen.dart</p>
