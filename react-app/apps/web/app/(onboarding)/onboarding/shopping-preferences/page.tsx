...
// Mirrors: lib/screens/onboarding/shopping/screen.dart
export default function OnboardingShoppingPreferencesPage() {
  ...
  return (
    <div>
      ...
      <p>Onboarding step 9 — TODO: port UI from Flutter shopping/screen.dart</p>
